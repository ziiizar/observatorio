...
const HeroLeft = () => {
  return (
    <div className="w-full lg:w-1/2 h-full mt-10 flex flex-col place-content-center gap-4 md:gap-6 ">
      ...
      <p className={cn("text-[clamp(1rem,2vw,1.125rem)] font-light text-balance", zodiak.className)}>
        Monitoreamos las tendencias y avances tecnológicos para impulsar
        el desarrollo energético y minero en Cuba.
      </p>
      <Button className="bg-burgundy-900 w-28 text-white shadow-shadowRed text-[clamp(0.875rem,1.5vw,1rem)] hover:bg-black hover:shadow-shadowBlack">
        Explorar
      </Button>
    </div>
  )
