...
const UserSection = () => {
  return (
    <>
      <div className="col-span-1 sm:col-span-2 lg:col-span-8 lg:row-span-1 rounded-xl flex justify-between bg-[url('/Servicios.webp')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        ...
        <div className="flex flex-col gap-2 sm:gap-4 z-20 px-4 sm:px-8 lg:px-16 py-6 sm:py-8 lg:py-10 place-content-center items-center backdrop-blur-sm w-full h-full rounded-xl">
          ...
          <p className={cn("text-sm sm:text-base text-balance text-center", zodiak.className)}>Explora nuestras herramientas de análisis con acceso a tablas, registros y gráficos detallados sobre avances tecnológicos en energía y minería.</p>
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex justify-between bg-[url('/Boletines.webp')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex justify-between bg-[url('/VIVO-azul.webp')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex place-content-center items-center bg-[url('/sobre-nosotros.webp')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
