...
const UserSection = () => {
  return (
    <>
      <div className="col-span-1 sm:col-span-2 lg:col-span-8 lg:row-span-1 rounded-xl flex justify-between bg-[url('/Servicios.png')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex justify-between bg-[url('/Boletines.png')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex justify-between bg-[url('/VIVO-azul.png')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 lg:row-span-1 rounded-xl flex place-content-center items-center bg-[url('/sobre-nosotros.png')] bg-shark-300 bg-center bg-cover bg-no-repeat relative">
        <div className="absolute inset-0 z-10 bg-black/50"></div>
        <div className="flex flex-col gap-2 z-20 p-4 sm:p-6 place-content-end backdrop-blur-sm w-full h-full rounded-xl">
