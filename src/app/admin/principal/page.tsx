...
const page = async () => {
  ...
  return (
    <main className="[grid-area:main] w-full h-full  flex flex-col  gap-4  pt-4 px-4">
      <div className="">
      ...
      <div className="w-full h-full  flex  gap-4 ">
        <div className="flex flex-col gap-4 h-full w-1/2">
          <div className="flex flex-col gap-4 w-full h-[50%]">
            <div className="flex gap-4 h-full">
              <article className="bg-dusty-gray-300 rounded-xl w-1/2  shadow-shadowBlackSmall p-4">
        ...
        <div className="flex flex-col gap-4 h-full w-1/2">
          <article className="bg-dusty-gray-300 rounded-xl w-full h-1/2 shadow-shadowBlackSmall p-4 flex gap-2">
            <div>
              <strong>Ejes Tematicos</strong>
              <ul className="flex flex-col gap-2 mt-4">
                <li className="flex gap-2  items-center">
                  <div className="size-4 bg-burgundy-900 rounded-md"></div>{" "}
                  Electroenergía - 20%
                </li>
                <li className="flex gap-2 items-center">
                  <div className="size-4 bg-[#0F7D6B] rounded-md"></div>Medio
                  Ambiente - 60%
                </li>
                <li className="flex gap-2 items-center">
                  <div className="size-4 bg-[#EDA145] rounded-md"></div>
                  Industrial - 20%
                </li>
              </ul>
            </div>
